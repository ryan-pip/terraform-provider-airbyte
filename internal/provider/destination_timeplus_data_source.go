...
var _ datasource.DataSource = &DestinationTimeplusDataSource{}
var _ datasource.DataSourceWithConfigure = &DestinationTimeplusDataSource{}

func NewDestinationTimeplusDataSource() datasource.DataSource {
	return &DestinationTimeplusDataSource{}
}
...
func (r *DestinationTimeplusDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_destination_timeplus"
}

// Schema defines the schema for the data source.
func (r *DestinationTimeplusDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *DestinationTimeplusDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *DestinationTimeplusDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *DestinationTimeplusDataSourceModel
