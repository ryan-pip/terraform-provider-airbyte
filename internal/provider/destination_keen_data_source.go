...
var _ datasource.DataSource = &DestinationKeenDataSource{}
var _ datasource.DataSourceWithConfigure = &DestinationKeenDataSource{}

func NewDestinationKeenDataSource() datasource.DataSource {
	return &DestinationKeenDataSource{}
}
...
func (r *DestinationKeenDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_destination_keen"
}

// Schema defines the schema for the data source.
func (r *DestinationKeenDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *DestinationKeenDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *DestinationKeenDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *DestinationKeenDataSourceModel
	...
	request := operations.GetDestinationKeenRequest{
		DestinationID: destinationID,
	}
	res, err := r.client.Destinations.GetDestinationKeen(ctx, request)
	if err != nil {
