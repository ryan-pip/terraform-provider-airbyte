...
var _ datasource.DataSource = &SourceOpenweatherDataSource{}
var _ datasource.DataSourceWithConfigure = &SourceOpenweatherDataSource{}

func NewSourceOpenweatherDataSource() datasource.DataSource {
	return &SourceOpenweatherDataSource{}
}

// SourceOpenweatherDataSource is the data source implementation.
type SourceOpenweatherDataSource struct {
	client *sdk.SDK
}

// SourceOpenweatherDataSourceModel describes the data model.
type SourceOpenweatherDataSourceModel struct {
...
func (r *SourceOpenweatherDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_source_openweather"
}

// Schema defines the schema for the data source.
func (r *SourceOpenweatherDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "SourceOpenweather DataSource",
...
func (r *SourceOpenweatherDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *SourceOpenweatherDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *SourceOpenweatherDataSourceModel
