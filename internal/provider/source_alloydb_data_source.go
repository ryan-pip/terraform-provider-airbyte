...
var _ datasource.DataSource = &SourceAlloydbDataSource{}
var _ datasource.DataSourceWithConfigure = &SourceAlloydbDataSource{}

func NewSourceAlloydbDataSource() datasource.DataSource {
	return &SourceAlloydbDataSource{}
}

// SourceAlloydbDataSource is the data source implementation.
type SourceAlloydbDataSource struct {
	client *sdk.SDK
}
...
func (r *SourceAlloydbDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_source_alloydb"
}

// Schema defines the schema for the data source.
func (r *SourceAlloydbDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *SourceAlloydbDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *SourceAlloydbDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *SourceAlloydbDataSourceModel
